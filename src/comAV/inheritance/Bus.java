...
public class Bus extends FuelAuto {
    ...
    public Bus (String producer, String model, Engine engine, int availablePetrol, int tankVolume) {
        super(producer, model, engine, availablePetrol, tankVolume);
    }

//    public Bus (String mercedes, String sprinter, int i, int availablePetrol, int tankVolume) {
//        super();
//    }

//    public Bus (String mercedes, String sprinter, int i, int i1, int i2) {
//        super();
//    }
